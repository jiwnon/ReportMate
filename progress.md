...
- **2025-03-03**: review 페이지 — GPT에 전달하는 활동을 학생마다 다르게 분배. A그룹(area_id 지정)은 해당 단원 학생들만, B그룹(area_id 없음)은 전체 학생 대상으로 N등분 배정. `assignActivityToStudent` 헬퍼 추가, 단원 미지정 활동도 GPT에 반영.
